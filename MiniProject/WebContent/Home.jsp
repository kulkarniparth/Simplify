...
<%
	...
	notice=(Notice)session.getAttribute("notice_info");
%>


 	<%
 			Jdbc noticeslist=new Jdbc();
 			List<Notice>notices=(List<Notice>)noticeslist.listNotices();
 	%>
  ...
  <main>
    <div class="position-relative">
      ...
      <section class="section section-sm section-shaped pb-15" style="height:700px;width: 100%">
        <div class="shape shape-style-1 bg-gradient-success" style="height:700px;width: 100%">
          <span></span>
          <span></span>
          <span></span>
          <span></span>
            ...
            <div class="row">
              <div class="col-sm-4">
                ...
                <% for(Notice tmp:notices){ %>
                  <div class="mySlides w3-container card bg-gradient-success shadow-lg border-0">
                    <h1><b>Notice :</b></h1>
                    <h1 style="color: white"><%=tmp.getNotice_description()%></h1>
                  </div>
                  <%} %>
          ...
          <div class="p-5">
            <div class="row align-items-center">
              ...
              <div class="col-lg-3 ml-lg-auto">
                <a href="http://localhost:8080/MiniProject/Login.jsp" class="btn btn-lg btn-block btn-white">Login</a>
              </div>
            </div>
          </div>
        </div>
