...
<header class="header-global">
  ...
  <main>
    <section class="section section-shaped section-lg">
      ...
      <form id="regForm" action="SigninController" method="post">
        <h1>Register</h1>
        		<input type="hidden" name="usertype" value="student">
          <p><input oninput="this.className = ''" name="project_id" value=<%=id%> readonly></p><br>
          <p><input placeholder="Student ID" oninput="this.className = ''" name="student_id"></p><br>
          <p><input placeholder=" Student Name " oninput="this.className = ''" name="student_name"></p><br>
          <p><input placeholder="Student Department " oninput="this.className = ''" name="student_dept"></p><br>
          <p><input placeholder="Student Batch" oninput="this.className = ''" name="student_batch"></p><br>
          <p><input oninput="this.className = ''" name="teacher_id" value=<%=teacher_id %> readonly></p><br>
          <p><input placeholder="E-mail" oninput="this.className = ''" name="student_email"></p><br>
          <p><input placeholder="Set Password" oninput="this.className = ''" name="student_password"></p><br>  
