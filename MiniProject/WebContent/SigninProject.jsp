  ...
  <main>
    <section class="section section-shaped section-lg">
      ...
      <form id="regForm" action="SigninController" method="post">
        ...
        <input type="hidden" name="usertype" value="project">
          <p><input  oninput="this.className = ''" name="project_id" value=<%=id%> readonly></p><br>
          <p><input placeholder="Project Title" oninput="this.className = ''" name="project_title"></p><br>
          <p><input placeholder="Project Domain" oninput="this.className = ''" name="project_domain"></p><br>
          <p><input placeholder="Project Description" oninput="this.className = ''" name="project_description"></p><br>
          <p><input placeholder="Project Link" oninput="this.className = ''" name="project_link"></p><br>
          <p><input placeholder="Teacher Id" oninput="this.className = ''" name="teacher_id"></p><br>
          <p>Enter the technologies you are thinking of using...<br>
            <input type="checkbox" name="tech" value="1"> Java<br>
			<input type="checkbox" name="tech" value="2"> NodeJS<br>
			<input type="checkbox" name="tech" value="3"> PHP<br>
			<input type="checkbox" name="tech" value="4"> Flask<br>  
