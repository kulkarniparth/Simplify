    ...
    <section class="section section-shaped section-lg">
     ...
     <form id="regForm" action="SigninController" method="post">
        <h1>Register</h1>
          ...
          <p><input placeholder="Login Id" oninput="this.className = ''" name="teacher_id"></p>
          <p><input placeholder="Name " oninput="this.className = ''" name="teacher_name"></p>
          <p><input placeholder="Department " oninput="this.className = ''" name="teacher_dept"></p>
          <p><input placeholder="E-mail" oninput="this.className = ''" name="teacher_email"></p>
          <p><input placeholder="Create Password" oninput="this.className = ''" name="teacher_password"></p>
